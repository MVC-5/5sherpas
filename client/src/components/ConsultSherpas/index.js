  ...
  return (
    <>
      ...
      <div className="knot-container">
        <button onClick={(e) => handleSherpaClick(e.target.id)}>
          {" "}
          <img
            className="sherpa-img s-10"
            id="Caleb"
            src={sherpa5}
            alt="sherpa5"
          />
        ...
        <button onClick={(e) => handleSherpaClick(e.target.id)}>
          {" "}
          <img className="yak-img s-yak" src={yak1} id="PC Yak" alt="yak1" />
        </button>
